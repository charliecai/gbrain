...
export function loadConfig(): GBrainConfig | null {
  ...
  const merged = {
    ...
    ...((process.env.GBRAIN_EMBEDDING_MODEL || process.env.GBRAIN_EMBED_MODEL)
      ? { embedding_model: process.env.GBRAIN_EMBEDDING_MODEL || process.env.GBRAIN_EMBED_MODEL }
      : {}),
    ...((process.env.GBRAIN_EMBEDDING_DIMENSIONS || process.env.GBRAIN_EMBED_DIMENSIONS)
      ? { embedding_dimensions: parseInt(process.env.GBRAIN_EMBEDDING_DIMENSIONS || process.env.GBRAIN_EMBED_DIMENSIONS || '', 10) }
      : {}),
    ...((process.env.GBRAIN_QUERY_EXPANSION_MODEL || process.env.GBRAIN_EXPANSION_MODEL)
      ? { expansion_model: process.env.GBRAIN_QUERY_EXPANSION_MODEL || process.env.GBRAIN_EXPANSION_MODEL }
      : {}),
